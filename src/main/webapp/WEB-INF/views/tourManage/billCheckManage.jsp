						...
						<table aria-describedby="sample-table-2_info" id="sample-table-2" class="table table-striped table-bordered table-hover dataTable">
							<thead>
								<tr role="row">
									...
									<th aria-label="Price: activate to sort column ascending" style="width: 50%;" colspan="1" rowspan="1" aria-controls="sample-table-2" tabindex="0" role="columnheader" class="sorting">
										供应商
									</th>
									<th aria-label="Price: activate to sort column ascending" style="width: 50%;" colspan="1" rowspan="1" aria-controls="sample-table-2" tabindex="0" role="columnheader" class="sorting">
										签单总计
					...
					<div class="modal-dialog" style="width: 80%;">
						<div class="modal-content">
						         	...
						         	<table class="table table-striped table-bordered table-hover no-margin">
										<thead>
											<tr>
												...
												<th style="width: 12.5%;">内容</th>
												<th style="width: 12.5%;">成本</th>
												<th style="width: 12.5%;">数量</th>
												<th style="width: 12.5%;">天数</th>
												<th style="width: 12.5%;">成本小计</th>
												<th style="width: 12.5%;">签单金额</th>
												<th style="width: 12.5%;">明细备注</th>
											</tr>
										</thead>
										<tbody id="payTable">
										</tbody>
							...
							<div class="modal-footer no-margin-top">
								...
								<button id="payApplication" class="btn btn-sm btn-success pull-right">
...
<script type="text/javascript">
	...
	/* 初始化 */
		...
		$("#autoAdd").click(function(){
			var inputs = $("#payTable").find("input").not(".ace");
			...
			if(checkbox.length==0){
				...
				$.ajax({
			        ...
			        success:function(data){
			        	$("#payTable").html("");
						$.each(data.costViewModels,function(){
							$("#payTable").append('<tr>'+
						...
						$.each(data.changeCostViewModels,function(){
							$("#payTable").append('<tr>'+
														'<td><label><input class="ace" type="checkbox"><span class="lbl"></span></label></td>'+
														'<td>'+this.costTable.costDate+'</td>'+
														'<td>'+this.contentName+'</td>'+
