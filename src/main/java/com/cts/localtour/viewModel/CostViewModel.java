...
public class CostViewModel {
	...
	public ArrayList<CostViewModel> getAllCostViewModel(int tourId){
		ArrayList<CostTable> costTables = (ArrayList<CostTable>) userService.getAllByString("CostTable", "tourId=?", tourId);
		...
		for (CostTable costTable : costTables) {
			...
			cost.setBorrowUserName(userService.getUserName(costTable.getBorrowUserId()));
